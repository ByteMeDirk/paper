...
urlpatterns = [
    ...
    path("resolve_user_report/<int:report_id>/", views.resolve_user_report, name="resolve_user_report"),
    path("resolve_post_report/<int:report_id>/", views.resolve_post_report, name="resolve_post_report"),
]
